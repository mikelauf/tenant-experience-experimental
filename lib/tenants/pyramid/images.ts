...
/**
 * Every Pyramid photo, in one place. "building" photos are from transamericapyramid.com.
...
export const images = {
  /* The building */
  aerialGolden: p(
    "building/aerial-golden",
    "The Pyramid rising above the Financial District at golden hour, the Golden Gate and Marin beyond",
    "building",
    "54% 42%",
  ),
  ...
  siteMap: p(
    "building/site-map",
    "Site plan of the Pyramid block: Montgomery, Washington, Sansome and Clay streets, with Redwood Park at the center",
    "building",
    "50% 50%",
  ),
  ...
  /* Bay Lounge (Level 27) */
  bayDay: p(
    "venues/bay-lounge-day",
    "Bay Lounge by day: curved channel-tufted sofas beneath tall windows looking out to Coit Tower and the bay",
    "building",
    "18% 72%",
  ),
  ...
  boardroomReal: p(
    "spaces/boardroom-real",
    "A boardroom with a long oak table, leather chairs and a wall display beneath a sculpted ceiling",
    "building",
    "55% 55%",
  ),
